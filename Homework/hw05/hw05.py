...
class VendingMachine:
    ...
    def add_funds(self,x):
        if self.stock ==0:
            ...
            self.balance = 0
            return 'Machine is out of stock. Here is your $'+str(newBalance)+'.'
    ...
    def vend(self):
        ...
        if self.balance >=self.price:
            ...
            if self.balance != 0:
                ...
                self.balance = 0
                return 'Here is your '+str(self.product)+' and $'+str(newBalance)+' change.'
            else:
...
def generate_paths(t, value):
    ...
    for branch in t.branches:
        for paths in generate_paths(branch,value):
            yield [t.label]+paths
